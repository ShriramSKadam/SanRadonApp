...
public class ApiResponseActionResult: Codable {
    ...
    public init(code: Int?, requestKey: String?, message: String?, detail: String?, result: ActionResult?, hasError: Bool?) {
        self.code = code
    ...
    public required init(from decoder: Decoder) throws {
        ...
        result = try container.decodeIfPresent(ActionResult.self, forKey: "result")
