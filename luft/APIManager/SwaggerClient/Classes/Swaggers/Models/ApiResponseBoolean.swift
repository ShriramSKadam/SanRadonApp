...
public class ApiResponseBoolean: Codable {
    ...
    public init(code: Int?, requestKey: String?, message: String?, detail: String?, result: Bool?, hasError: Bool?) {
        self.code = code
