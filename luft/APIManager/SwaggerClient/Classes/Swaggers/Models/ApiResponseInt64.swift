...
public class ApiResponseInt64: Codable {
    ...
    public init(code: Int?, requestKey: String?, message: String?, detail: String?, result: Int64?, hasError: Bool?) {
        self.code = code
