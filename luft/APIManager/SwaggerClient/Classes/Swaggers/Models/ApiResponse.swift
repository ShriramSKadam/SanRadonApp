...
public class ApiResponse: Codable {
    ...
    public init(code: Int?, requestKey: String?, message: String?, detail: String?, result: Any?, hasError: Bool?) {
        self.code = code
    ...
    public required init(from decoder: Decoder) throws {
        ...
        result = try container.decodeIfPresent(Any.self, forKey: "result")
