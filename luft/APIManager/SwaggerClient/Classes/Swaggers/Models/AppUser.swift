...
public class AppUser: Codable {
    ...
    //New Parameter added - Jan20,2022
    ...
    public required init(from decoder: Decoder) throws {
        ...
        oauthProvider = try container.decodeIfPresent(String.self, forKey: "oauthProvider")
    }
}
