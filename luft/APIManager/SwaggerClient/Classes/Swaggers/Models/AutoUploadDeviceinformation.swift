//
// AutoUploadDeviceinformation.swift
//
...
public class AutoUploadDeviceinformation: Codable {

    public var calibrationDate: String?
    public var calibrationFactors: [AutoUploadCalibarationFactor]?
    ...
    public init(calibrationDate: String?, calibrationFactors: [AutoUploadCalibarationFactor]?, deviceName: String?, modelNumber: String?, nextCalibrationDate: String?, serialNumber: String?, batteryPercent: String?, externalModuleFWRevision: String?) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        calibrationFactors = try container.decodeIfPresent([AutoUploadCalibarationFactor].self, forKey: "calibrationFactors")
