//
// RegisterSocialUserViewModel.swift
//
...
public class RegisterSocialUserViewModel: Codable {
    ...
    public init(accessToken: String, phoneNumber: String, provider: String, deviceToken: String?, deviceId: String?, loginDevice: Int64?, isWeb: Bool?, userAgentId: String?, name: String?, email: String?, osVersion: String?, osName: String?, mobileDeviceModel: String?, appversion: String?, buildVersion: String?) {
