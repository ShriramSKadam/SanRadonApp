//
// SearchResultInspectionDetails.swift
//
...
public class SearchResultInspectionDetails: Codable {

    public var totalNoOfRecords: Int64?
    public var records: [InspectionDetails]?
    public var inspectionIds: [Int64]?


    
    public init(totalNoOfRecords: Int64?, records: [InspectionDetails]?, inspectionIds: [Int64]?) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        records = try container.decodeIfPresent([InspectionDetails].self, forKey: "records")
