...
public class InspectedBy: Codable {
    ...
    public init(name: String?, email: String?, address: String?, city: String?, state: String?, zipcode: String?, contact: String?, headerImage: String?, licenseType: String?, licenseNo: String?) {
        self.name = name
        self.email = email
