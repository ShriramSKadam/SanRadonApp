//
//  webdata2ViewController.swift
//  Luft
//
//  Created by Subramanian A on 14/10/22.
...
class webdata2ViewController: UIViewController, WKUIDelegate,WKNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        if self.isFromIntial == true {
           let link = URL(string:Urltodisplay)!
...
//        }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if self.isFromIntial == true {
            ...
            self.btnWebView.setTitle("Close", for: .normal)
            self.btnWebView.titleLabel?.font = UIFont.boldSystemFont(ofSize: 17)
            self.btnWebView.layer.cornerRadius = 5
            self.btnWebView.layer.borderWidth = 2
            self.btnWebView.layer.borderColor = UIColor.black.cgColor
...
//        self.btnWebView.setTitle("OK", for: .normal)
//
////        let link = URL(string:TERMS_AND_CONDTIONS)!
//        let link = URL(string:UNITS_URL)!
//
//        let request = URLRequest(url: link)
//        self.webViewIntial?.load(request)
